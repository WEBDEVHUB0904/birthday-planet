    ...
    <section ref={sectionRef} className="cg-letter">
      ...
      <div className="cg-letter__content" data-reveal-group>
        ...
        <p className="cg-letter__body" data-reveal-item>
          Before you, the days moved without weight. After you, every small thing
          carried a second meaning. I didn't plan this. I don't think anyone plans
          something like this. It just happened — quietly, irrevocably, like gravity.
        </p>
        <div className="cg-letter__ink" data-reveal-item>
          ...
          <span className="cg-letter__ink-spread" aria-hidden="true" />
        </div>
      </div>
    </section>
  );
